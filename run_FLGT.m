%% This code demonstrates the faster variant of the proposed temporal region detection algorithm - "FLGT"
...
imwrite(salMap, 'Output\frame_51_FLGT.png');  % Writig the output saliency maps
toc;
