%% This code demonstrates the proposed spatiotemporal region detection algorithm "STS"
...
[lc, csp, sc] = regionSpectralClustering(ls, sp, am, 5, 10);  % Region segmentation using spectral clustering
...
imwrite(salMap, 'Output\frame_51_STS.png');  % Writig the output saliency maps
toc;
